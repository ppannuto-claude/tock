...
//! by both FPGA images.
//!
//! This is not the machine's full interrupt map, and most of what is here
//! is unused: `Mps2DefaultPeripherals` drives only UART0, TIMER0 and the
//! Shield0 PL022. The rest are listed so their numbering is on hand for a
//! board that wants to wire them up.
