...
//!
//! Every raw address this chip uses is here, including UART1-4 and Timer1,
//! which nothing currently drives.
...
///
/// Unlike everything above, this address is fixed by the architecture
/// rather than by this machine.
