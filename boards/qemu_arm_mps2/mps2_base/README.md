...
so `make init` replaces whatever was registered before, including the other
MPS2 board's. Run it in the board directory you are about to use, and again
whenever you switch boards:
